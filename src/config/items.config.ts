...
export const ITEMS: Item[] = [
    ...
    },
    {
        ...
        passive: {
            ...
            stats: [
                ...
                { name: "bonus_ammo", amount: 1, type: "percentage" },
            ],
            cooldown: 10,
        },
        additionalInfo:
    ...
    },
    {
        ...
        category: "weapon",
        tier: 2,
        stats: [{ name: "weapon_damage", amount: 0.07, type: "percentage" }],
        passive: {
            condition: "hit_hero",
            stats: [
                { name: "spirit_amp", amount: 0.1, type: "percentage" },
    ...
    },
    {
        ...
        active: {
            stats: [
                { name: "movement_speed", amount: 3, type: "flat" },
    ...
    },
    {
        ...
        category: "weapon",
        tier: 3,
        stats: [{ name: "bonus_health", amount: 150, type: "percentage" }],
        passive: {
            condition: "radius",
            stats: [
    ...
    },
    {
        ...
        passive: {
            ...
            stats: [{ name: "max_weapon_damage", amount: 0.6, type: "percentage" }],
            duration: 3,
        },
    },
    {
    ...
    },
    {
        ...
        passive: {
            condition: "long_range_15m",
            stats: [{ name: "weapon_damage", amount: 0.7, type: "percentage" }],
        },
    },
    {
        name: "tesla_bullets",
        category: "weapon",
        tier: 3,
        stats: [{ name: "fire_rate", amount: 0.14, type: "percentage" }],
        additionalInfo:
    ...
    },
    {
        ...
        category: "weapon",
        tier: 3,
        stats: [{ name: "bonus_health", amount: 100, type: "flat" }],
        passive: {
            condition: "hit_hero",
            stats: [
    ...
    },
    {
        ...
        passive: {
            ...
            stats: [{ name: "minion_fire_rate", amount: 0.4, type: "percentage" }],
        },
        active: {
            condition: "radius",
            stats: [
    ...
    },
    {
        ...
        active: {
            ...
            stats: [{ name: "bullet_resist", amount: 0.3, type: "percentage" }],
            duration: 5,
            cooldown: 16,
        },
    },
